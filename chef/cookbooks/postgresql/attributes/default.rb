...
#default["postgresql"]["archive_command"]                 = "mkdir -p archivedir && test ! -f archivedir/%f && cp %p archivedir/%f"
#default["postgresql"]["restore_command"]                 = "cp archivedir/%f %p"
...
default["postgresql"]["wal_keep_segments"]               = 256
